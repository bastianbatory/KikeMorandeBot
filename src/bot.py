...
def run_discord_bot():
    ...
    async def help(interaction: discord.Interaction):
        await interaction.response.defer(ephemeral=False)
        await interaction.followup.send(""":star: **BASIC COMMANDoooooS** \n
...
https://github.com/Zero6992/chatGPT-discord-bot""")
    ...
    @app_commands.choices(persona=[
        ...
        app_commands.Choice(name="Pepsiman", value="pepsiman"),
    ])
        ...
        if discordClient.is_replying_all == "True":
            ...
            if discordClient.replying_all_discord_channel_id:
                if message.channel.id == int(discordClient.replying_all_discord_channel_id):
                    ...
                    logger.info(f"HISTORY: {discordClient.conversation_history}")
